...
export default async function Availability(){
  ...
  return <main><h1>Your availability</h1><p className="muted">This is your persistent weekly raid schedule—similar to an Adventurer Plate. You do not need to create dated availability entries anymore.</p>{chars.rows.length?<WeeklyAvailabilityForm encounters={enc.rows} characters={chars.rows} initial={initial}/>:<div className="card">Add at least one character in your profile before publishing availability.</div>}</main>;
}
