...
export async function POST(req: NextRequest) {
  ...
  if([d.needPhysical,d.needMagical,d.needSupport].some(n=>n>raid.rows[0].party_size))return NextResponse.json({error:"need_exceeds_party_size"},{status:400});
