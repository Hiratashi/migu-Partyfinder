...
export default async function Home() {
  ...
  const invitations=await query<Inv>(`
    SELECT
      p.id,
      p.start_time,
  ...
  return <main>
    ...
    <h2 className="section-title">Open parties</h2>
    <div className="grid">
      {parties.rows.length===0&&
        <div className="card muted">
          No open parties yet. Create one or publish your availability.
        </div>
      }
